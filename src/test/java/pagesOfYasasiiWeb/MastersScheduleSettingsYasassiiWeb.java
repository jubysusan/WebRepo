...
public class MastersScheduleSettingsYasassiiWeb extends PageFactoryInitYasasiiWeb {
	...
	@FindBy(xpath = "//body/app-root[1]/app-layout[1]/main[1]/app-asideleftbar[1]/aside[1]/div[1]/div[2]/ul[1]/li[7]/a[1]")
...
//		Up.click();
		...
		WebElement set1 = driver.findElement(By.cssSelector("#owl-dt-picker-3 > div.owl-dt-container-inner.ng-trigger.ng-trigger-fadeInPicker > div > button:nth-child(2)"));
