...
public class EMR_BirthRegTwoChildYasasiiWeb extends PageFactoryInitYasasiiWeb{
	

	 public EMR_BirthRegTwoChildYasasiiWeb(WebDriver driver) {
		...
		public WebElement SAve;
		@FindBy(xpath = "//span[contains(text(),'Mr Rohit Sharma')]")
		public WebElement Logoutdwnarw;
		@FindBy(xpath = "//header/nav[1]/div[2]/ul[2]/li[5]/div[1]/div[1]/a[6]/span[1]/img[1]")
		...
		@FindBy(xpath = "//button[@id='savepatadtbutton']")
		public WebElement SAVE;
		@FindBy(xpath = "//body/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[1]/lib-patientlist[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]")
		...
		@FindBy(xpath = "//body/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[1]/lib-patientlist[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/img[1]")
		public WebElement SelectBaby2;
		@FindBy(xpath = "//body/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[1]/lib-patientlist[1]/form[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[5]")
...
public void Action1(String FirstName,String AadharNumber) throws InterruptedException, IOException {
...
public void Action3(String FirstName,String AadharNumber) throws InterruptedException, IOException {
	...
	SelectBaby1.click();      // Baby1 Discharge
	Thread.sleep(1000);
	Dischargestat.click();
	Thread.sleep(1000);
	...
	Selectmother.click();   //patient Discharge
	Thread.sleep(1000);
	Dischargestat.click();
	Thread.sleep(1000);
	SelectDischargestat.click();
...
public void SecondbabyDis(String FirstName,String AadharNumber) throws InterruptedException, IOException {
		
	SelectBaby2.click();           //baby2 Discharge
	Thread.sleep(1000);
	Dischargestat.click();
	Thread.sleep(1000);
	SelectDischargestat.click();
